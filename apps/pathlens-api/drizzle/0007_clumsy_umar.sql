...
CREATE INDEX "funnels_workspace_idx" ON "funnels" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "funnels_project_idx" ON "funnels" USING btree ("project_id");